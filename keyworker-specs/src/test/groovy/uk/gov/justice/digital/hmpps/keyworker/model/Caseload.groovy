...
enum Caseload {
    ...
    MDI('MDI', 'MOORLAND CLOSED (HMP & YOI)', INST),
    ...
    ZZGHI('ZZGHI', 'GHOST HOLDING ESTABLISHMENT', INST),
    ...
    Caseload(String id, String description, CaseloadType type) {
        this.id = id
