...
import { forenameToInitial } from './stringUtils'
  ...
  <>
    {headerHtml ? (
      ...
      <header className="fallback-dps-header" role="banner">
        <div className="fallback-dps-header__container">
          <div className="fallback-dps-header__title">
            <a
              className="fallback-dps-header__link fallback-dps-header__link--no-underline fallback-dps-header__title__service-name"
              href={dpsUrl}
            >
              <svg
                role="presentation"
                focusable="false"
                className="fallback-dps-header__logo"
          ...
          <nav aria-label="Account navigation">
            <ul className="fallback-dps-header__navigation">
              <li className="fallback-dps-header__navigation__item">
                <a className="dps-header__link" href={`${authUrl}/account-details`} data-test="manage-account-link">
                  <span data-test="logged-in-name">{forenameToInitial(user.name)}</span>
                  <span className="dps-header__link__sub-text">Manage your details</span>
                </a>
              </li>
              ...
              <li className="fallback-dps-header__navigation__item">
                <a
                  data-qa="signOut"
                  className="fallback-dps-header__link fallback-dps-header__link--no-underline fallback-dps-header__sign-out"
                  href="/sign-out"
                >
                  Sign out
                </a>
