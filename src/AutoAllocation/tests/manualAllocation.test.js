...
describe('ManualAllocation component', () => {
  it('should render list correctly', async () => {
    const component = shallow(<ManualAllocation allocatedKeyworkers={[]} allocatedList={allocatedList} keyworkerList={keyworkList} handleKeyworkerChange={() => {}} postManualOverride={() => {}} applyDateFilter={() => {}} onFinishAllocation={() => {}}/>);
  ...
  it('should display allocations if keyworker details available', async () => {
    const component = shallow(<ManualAllocation
