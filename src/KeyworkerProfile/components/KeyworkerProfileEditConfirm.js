    ...
    if (this.props.status !== 'INACTIVE') {
      innerContents = (<div className="pure-u-md-6-12">
        ...
        <div className="multiple-choice">
          <input type="radio" name="allocationOption" value="keepAllocations" onClick={this.props.handleOptionChange}/>
          <label>Continue to auto-allocate
          prisoners to this key worker and keep those already
          allocated to them</label>
        </div>
        <div className="multiple-choice">
          <input type="radio" name="allocationOption" value="keepAllocationsNoAuto" onClick={this.props.handleOptionChange}/>
          <label>No longer
          auto-allocate to key worker but keep those already allocated to them</label>
        </div>
        <div className="multiple-choice">
          <input type="radio" name="allocationOption" value="removeAllocations" onClick={this.props.handleOptionChange}/>
          ...
          <div className="pure-g padding-top">
            <div className="pure-u-md-2-12">
              ...
              <div id="keyworker-status" name="keyworker-status"
                className={`${statusStyle}Status`}>{this.props.status}</div>
            </div>
          </div>
