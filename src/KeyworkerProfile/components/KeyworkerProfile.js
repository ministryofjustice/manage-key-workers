...
class KeyworkerProfile extends Component {
  ...
  render () {
    ...
    renderContent = (<div>
        <div className="lede padding-top padding-bottom-large bold">Current key worker allocations <div id="allocationCount" className={allocationCountStyle}><span className="allocationCount">{this.props.keyworkerAllocations.length}</span></div></div>
