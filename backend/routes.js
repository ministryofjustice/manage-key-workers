...
const configureRoutes = ({ oauthApi, elite2Api, keyworkerApi }) => {
  ...
  router.use('/api/auth-user-get', withErrorHandler(authUserMaintenanceFactory(oauthApi).getUser))
  router.use('/api/auth-user-create', withErrorHandler(authUserMaintenanceFactory(oauthApi).createUser))
  router.use('/api/auth-user-search', withErrorHandler(authUserMaintenanceFactory(oauthApi).search))
  ...
  router.use('/api/auth-user-create', withErrorHandler(authUserMaintenanceFactory(oauthApi).createUser))
  router.use('/api/auth-user-amend', withErrorHandler(authUserMaintenanceFactory(oauthApi).amendUser))
