...
context('View residential location', () => {
  ...
  beforeEach(() => {
    ...
    cy.task('stubOffenderSentences', [
      { offenderNo: 'ABC123', sentenceDetail: { releaseDate: '2022-04-30', mostRecentActiveBooking: true } },
      { offenderNo: 'ABC456', sentenceDetail: { releaseDate: '2030-05-30', mostRecentActiveBooking: true } },
      { offenderNo: 'ABC789', sentenceDetail: { releaseDate: '2029-02-28', mostRecentActiveBooking: true } },
    ])
